...
| **interiors** (0.5k) | Apartment interior scene, colliders, layout, interior interactions | `ApartmentInterior.tsx`, `apartmentLayout.ts`, `interiorTypes.ts` | [SYSTEMS §Apartment](SYSTEMS.md#apartment--interiors) |
